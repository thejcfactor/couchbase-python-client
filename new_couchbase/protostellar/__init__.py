...
from .proto.couchbase.kv.v1 import kv_pb2_grpc
...
# # query
# query_grpc_spec = importlib.util.spec_from_file_location('query_pb2_grpc', os.path.join(pathlib.Path(__file__).parent, 'proto', 'couchbase', 'query', 'v1', 'query_pb2_grpc.py'))
# query_grpc_module = importlib.util.module_from_spec(query_grpc_spec)
# query_grpc_spec.loader.exec_module(query_grpc_module)
from .proto.couchbase.query.v1 import query_pb2_grpc
...
from .proto.couchbase.admin.bucket.v1 import bucket_pb2_grpc
