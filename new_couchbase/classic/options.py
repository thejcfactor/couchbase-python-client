...
from new_couchbase.common._utils import (timedelta_as_microseconds,
                                                ...
                                                validate_transcoder)
from new_couchbase.classic._utils import timedelta_as_timestamp
from new_couchbase.classic.durability import DurabilityParser
...
class ValidKeyValueOptions:
    ...
    def get_valid_options(opt_type # type: OptionTypes
        ...
        elif opt_type == OptionTypes.LookupIn:
            valid_opts = copy.copy(ValidKeyValueOptions._VALID_OPTS)
        elif opt_type == OptionTypes.MutateIn:
            valid_opts = copy.copy(ValidKeyValueOptions._VALID_DURABLE_OPTS)
            valid_opts.update({
