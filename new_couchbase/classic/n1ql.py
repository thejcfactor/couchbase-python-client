...
from new_couchbase.exceptions import(AlreadyQueriedException,
                                    CouchbaseException)
from new_couchbase.classic.exceptions import (PYCBC_ERROR_MAP,
                                  ErrorMapper,
                                  ExceptionMap)
from new_couchbase.classic.exceptions import exception as CouchbaseBaseException
from new_couchbase.classic.core.n1ql import N1QLRequestCore

class N1QLRequest(N1QLRequestCore):
    def __init__(self,
                 connection,
                 query_params,
