...
from new_couchbase.auth import CertificateAuthenticator, PasswordAuthenticator
...
from new_couchbase.classic.options import ValidClusterOptions, ValidDiagnosticOptions
